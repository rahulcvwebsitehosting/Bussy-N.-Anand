...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-24 bg-[#3D0606] relative border-t border-white/10">
          ...
          >
            <div className="bg-transparent p-8 md:p-10 rounded-sm shadow-2xl h-full border border-white/5 flex flex-col justify-between relative overflow-hidden group">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="https://www.instagram.com/bussyanandoffl/" target="_blank" rel="noopener noreferrer" className="text-primary font-bold hover:text-white transition-colors mt-1 inline-block">@bussyanandoffl</a>
                    </div>
                  </div>
              ...
              <div className="mt-12 pt-6 border-t border-white/5 flex justify-center gap-4">
                 <a href="https://x.com/BussyAnand?lang=en" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-dark rounded-full flex justify-center items-center text-primary border border-primary/30 hover:bg-primary/20 hover:border-primary transition-colors cursor-pointer">
                 ...
                 <a href="https://www.instagram.com/bussyanandoffl/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-dark rounded-full flex justify-center items-center text-primary border border-primary/30 hover:bg-primary/20 hover:border-primary transition-colors cursor-pointer">
                 ...
                 <a href="https://www.facebook.com/profile.php?id=100094785247186" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-dark rounded-full flex justify-center items-center text-primary border border-primary/30 hover:bg-primary/20 hover:border-primary transition-colors cursor-pointer">
                    <Facebook className="w-5 h-5" />
                 </a>
                 <a href="https://www.youtube.com/hashtag/bussyanand" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-dark rounded-full flex justify-center items-center text-primary border border-primary/30 hover:bg-primary/20 hover:border-primary transition-colors cursor-pointer">
